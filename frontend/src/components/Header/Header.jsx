...
function Header() {
    return (<>
        ...
        <header className="w-4/5 mt-5 m-auto pr-7 pl-7 sticky rounded-2xl border-zinc-500 bg-white/60 shadow-2xl top-5 flex justify-between backdrop-blur-2xl z-[9999]">
